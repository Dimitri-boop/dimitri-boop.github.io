...
if(isset($_REQUEST['update_restaurant_id']))
{
	try
	{
		$id = $_REQUEST['update_restaurant_id']; //get "update_id" from index.php page through anchor tag operation and store in "$id" variable
		$select_restaurant = $db->prepare('SELECT * FROM restaurant'); //sql select query
...
if(isset($_REQUEST['btn_update_restaurant']))
{
	try
	{
            ...
            <?php 
                ...
                echo "<form method='post' class='form-horizontal' enctype='multipart/form-data'>
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-12'>
                            <textarea name='textPresentation' class='form-control' rows='3'required>$textPresentation</textarea>
							</div>
                        </div>
                        ...
                        <div class='row'>
					        <div class='form-group col-md-6'>
						        ...
						        <div class='col-sm-12 col-md-6'>
							        <p><img src='../images/".$row['restaurantTerrasse1']."' height='250' width='auto' /></p>
							        <input type='file' name='restaurantTerrasse1' class='form-control' value='".$row['restaurantTerrasse1']."'/>
						    	</div>
					   		</div>
                        	...
                        	<div class='form-group col-md-6'>
								...
								<div class='col-sm-12 col-md-6'>
									<p><img src='../images/".$row['restaurantTerrasse2']."' height='250' width='auto' /></p>
									<input type='file' name='restaurantTerrasse2' class='form-control' value='".$row['restaurantTerrasse2']."'/>
								</div>
                        	</div>
                        </div>
                        ...
                        <div class='form-group row'>
                            <div class='col-sm-offset-3 col-sm-9 m-t-15'>
                                <input type='submit' name='btn_update_restaurant' class='btn btn-primary' value='Modifier'>
